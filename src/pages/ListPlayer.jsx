    ...
    <>
      {textArray.map((text, index) =>
        text.type === "badge" ? (
          <span
            key={"badge-" + index}
            className={"text badge " + text.className}
            style={text.style}
          >
            {text.content}
          </span>
          ...
          <span
            key={"text-" + index}
            className={"text pure " + text.className}
            style={text.style}
          >
            {text.link ? (
              <a
    ...
    <div className="lt-info-card">
      <div className="lt-info-panel">
        ...
        <div className="lt-info-stats">
          ...
          <span className="text pure number">
            {info.type === "artist" ? info.numAlbums : info.duration}
          </span>
        </div>
      </div>
      {info?.imageSrc || track?.imageSrc ? (
        <div className="lt-info-img-cont">
          <img
            className="lt-info-img"
            src={info.imageSrc ?? track.imageSrc}
            alt="list image"
          />
        </div>
      ) : (
...
export const ListControls = ({
  ...
  return (
    <div className="controller-panel">
      <button
        className="btn mute-btn btn-primary"
        onClick={() => muteCallback && muteCallback(!muted)}
      >
        {muted ? (
      ...
      <button
        ...
        onClick={() => playCallback && playCallback(!playing)}
      >
        {playing ? (
...
export const TrackOptionsMenu = ({ track }) => {
  ...
  return (
    <div className="track-options-menu">
      <button
        className="btn track-options-btn track-dl"
        onClick={() => console.log("Download: ", track)}
      >
        Download
      </button>
      <button
        className="btn track-options-btn track-add"
        onClick={() => console.log("Add to playlist: ", track)}
      >
        Add to Playlist
      </button>
      <button
        className="btn track-options-btn track-share"
...
export const ListPlayer = ({
  ...
  const handleTrackClick = (event, index) => {
    ...
    index === selectedTrack
      ? playPause(!isPlaying)
      : (allowScrollIntoView.current = false),
